  ...
  const columns = useMemo<Array<ColumnDef<MmsOrderRow>>>(
    () => [
      ...
      },
      {
        accessorKey: "amount",
        meta: { align: "center" },
        header: () => <div className="block w-full text-center">{t("mmsOrders.total")}</div>,
        cell: ({ row }) => (
      ...
      >
        ...
        <div className="ml-auto flex flex-wrap items-center justify-end gap-2">
          <div className="flex items-center gap-2">
            <p className="text-xs font-medium text-muted-foreground">{t("mmsOrders.period")}</p>
            <Select value={mode} onValueChange={handleModeChange}>
              <SelectTrigger className="w-[220px]">
                <SelectValue>
                  {mode === "today-yesterday" ? t("mmsOrders.todayYesterday") : t("mmsOrders.customRange")}
                </SelectValue>
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="today-yesterday">{t("mmsOrders.todayYesterday")}</SelectItem>
                <SelectItem value="custom">{t("mmsOrders.customRange")}</SelectItem>
              </SelectContent>
            </Select>
          </div>
